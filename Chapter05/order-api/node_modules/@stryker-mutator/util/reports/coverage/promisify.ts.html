...
<html lang="en">
<head>
    <title>Code coverage report for promisify.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> promisify.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { exec } from 'child_process';
...
function promisify(original: any) {
  <span class="missing-if-branch" title="else path not taken" >E</span>if ('promisify' in util) {
    return util.promisify(original); // let nodejs do it's thing thing, if it is supported
  } else {
<span class="cstat-no" title="statement not covered" >    return innerPromisify(original); </span>// Do it ourselves
  }
}
&nbsp;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Tue Nov 13 2018 21:02:47 GMT+0000 (Coordinated Universal Time)
</div>
</div>
