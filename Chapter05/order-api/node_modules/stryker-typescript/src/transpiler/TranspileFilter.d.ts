...
export default abstract class TranspileFilter {
    abstract isIncluded(fileName: string): boolean;
    static create(config: Config): TranspileFilter;
}
/**
 * A transpile filter based on ts config
 */
export declare class TSConfigFilter extends TranspileFilter {
 ...
 */
export declare class DefaultFilter extends TranspileFilter {
    isIncluded(fileName: string): boolean;
}
