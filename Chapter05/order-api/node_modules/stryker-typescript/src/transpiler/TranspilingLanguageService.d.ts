...
export default class TranspilingLanguageService {
    ...
    constructor(compilerOptions: Readonly<ts.CompilerOptions>, rootFiles: ReadonlyArray<File>, projectDirectory: string, produceSourceMaps: boolean);
    /**
     ...
     */
    replace(replacements: ReadonlyArray<File>): void;
    getSemanticDiagnostics(files: ReadonlyArray<File>): string;
    /**
