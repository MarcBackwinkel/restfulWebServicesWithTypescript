...
var TranspilingLanguageService = /** @class */ (function () {
    function TranspilingLanguageService(compilerOptions, rootFiles, projectDirectory, produceSourceMaps) {
        var _this = this;
        this.projectDirectory = projectDirectory;
        this.produceSourceMaps = produceSourceMaps;
        this.files = Object.create(null);
        this.logger = logging_1.getLogger(TranspilingLanguageService.name);
